          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile">
              ...
              <div class="profile_info">
                <span>Welcome,</span>
                <h2> {{ ucwords(Auth::user()->fname).' '.ucwords(Auth::user()->lastname) }}</h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Employee <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{route('employee.index')}}">List of Employee</a>
                      </li>
                      <li><a href="{{route('employee.create')}}">Add new Employee</a>
                      </li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img.jpg" alt="">{{ ucwords(Auth::user()->fname).' '.ucwords(Auth::user()->lastname) }}
